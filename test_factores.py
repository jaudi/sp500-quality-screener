...
universo = [
    # barata y de calidad, sin momentum
    {"ticker": "VALOR", "per_normalizado": 8, "precio_valor_libros": 0.9, "fcf_yield": 11.0,
     "ev_ebit": 6, "roic": 18, "margen_operativo": 22, "conversion_fcf": 1.1, "devengos": 0.01,
     "deuda_neta_ebitda": 0.5, "cobertura_intereses": 14, "retorno_6m": -12.0,
    ...
    {"ticker": "MOMENTO", "per_normalizado": 41, "precio_valor_libros": 9.5, "fcf_yield": 1.4,
     "ev_ebit": 33, "roic": 13, "margen_operativo": 16, "conversion_fcf": 0.8, "devengos": 0.09,
     "deuda_neta_ebitda": 2.9, "cobertura_intereses": 5, "retorno_6m": 61.0,
...
nd = puntuar_factores(
    [dict(e, crecimiento_ingresos_normalizado=g, crecimiento_beneficios_normalizado=g)
     for e, g in zip(universo, [2.0, 45.0, 11.0])],
    PESOS["nasdaq100"],
)
comprobar(nd[0]["ticker"] == "MOMENTO", f"con pesos Nasdaq gana el de crecimiento → {[e['ticker'] for e in nd]}")
